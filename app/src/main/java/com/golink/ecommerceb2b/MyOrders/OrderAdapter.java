...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.orderId.setText("Order ID: " + carItems.getOrderId());
        holder.orderBus.setText("Company: " + carItems.getId());
        holder.orderPrice.setText("₹ " + carItems.getPrice());
        holder.orderDate.setText(carItems.getTime());
        if(carItems.getStatus().equals("1"))
            holder.orderStatus.setText("PLACED");
        else if(carItems.getStatus().equals("2"))
...
//        }
                ...
                new AlertDialog.Builder(mCtx, R.style.MyDialogTheme)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.CANCEL_ORDER, new Response.Listener<String>() {
                                    @Override
                                    ...
                                    protected Map<String, String> getParams() throws AuthFailureError {
                                        ...
                                        paramMap.put("order_payment_id", carItems.getOrderId());
    ...
    class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerViewHolder(View itemView) {
            ...
            orderBus = itemView.findViewById(R.id.orderBus);
