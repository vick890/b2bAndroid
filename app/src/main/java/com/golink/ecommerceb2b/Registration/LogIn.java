...
public class LogIn extends AppCompatActivity {
    ...
    private EditText registrationNumberEditText, logRefer;
    ...
    public static String login = "com.ecomU.login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logRefer = findViewById(R.id.logRefer);
...
//        });
        ...
        registrationSignButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String refer = logRefer.getText().toString();
    ...
    private void login(final String phone, final String refer) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.SIGNUP, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                paramMap.put("reffer_code", refer);
