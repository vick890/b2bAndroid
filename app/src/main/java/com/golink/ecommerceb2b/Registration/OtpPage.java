...
public class OtpPage extends AppCompatActivity {
    ...
    private void signup(){
        ...
        mAuth.createUserWithEmailAndPassword(("user" + phone + "@gmail.com"), (phone))
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if(user!= null){
                                ...
                                databaseReference.child("email").setValue("user" + phone + "@gmail.com");
    ...
    private void login(){
        ...
        mAuth.signInWithEmailAndPassword(("user" + phone + "@gmail.com"), (phone))
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
