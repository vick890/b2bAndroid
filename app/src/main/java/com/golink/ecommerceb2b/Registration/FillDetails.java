...
import com.golink.ecommerceb2b.Utils.Validations;
...
public class FillDetails extends AppCompatActivity {
    ...
    private EditText profileEmailEditText, profileNameEditText, profileAddressEditText, profileBusinessEditText, profileMobileEditText,
                ...
                public void onResponse(final String response) {
                    ...
                    try {
                        ...
                        if(!error){
                            ...
                            String year = obj1.getString("mobile2");
...
//                                }
        ...
        registrationUpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String mobile = profileMobileEditText.getText().toString();
                ...
                if(!TextUtils.isEmpty(name) && !TextUtils.isEmpty(address) && !TextUtils.isEmpty(addressCity) && !TextUtils.isEmpty(addressState)){
                    if(!TextUtils.isEmpty(email) && Validations.emailValidator(email)){

                        if(!TextUtils.isEmpty(mobile) && Validations.isValidMobile(mobile, 10)){

                            profile(name, email, address, mobile, business, addressCity, addressState);
                        }else
    ...
    private void profile(final String name, final String email, final String address, final String mobile, final String business,
                                        ...
                                        public void onResponse(JSONObject jsonObject) {
                                            ...
                                            try {
                                                ...
                                                if(!error){
                                                    ...
                                                    final StorageReference ref = mStorage.child("UsersImages").child(mAuth.getCurrentUser().getUid()).child(resultUriP.getLastPathSegment());
                                                    ...
                                                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Uri> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                if(page.equals("edit")){
                                                                    Toast.makeText(FillDetails.this, "Profile Updated Successfully!", Toast.LENGTH_SHORT).show();
                                                                    ...
                                                                    Intent intent = new Intent(FillDetails.this, TermsConditions.class);
                                                                    startActivity(intent);
                                                                }
